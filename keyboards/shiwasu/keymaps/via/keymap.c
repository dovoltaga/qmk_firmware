...
[_RAISE] = LAYOUT_split_3x6_4(
  ...
  _______, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, _______,                   S(KC_MINS), S(KC_PLUS), S(KC_BSLS), _______,   S(KC_SCLN), S(KC_QUOT), \
  _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, _______, _______, _______, S(KC_LBRC), S(KC_RBRC), S(KC_COMM), S(KC_DOT), S(KC_SLSH), _______, \
                                      _______, _______, _______, _______, _______, _______  \
),
