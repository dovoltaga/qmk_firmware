 ...
 * | TAB  |  F1  |  F2  |  F3  |  F4  |      |      |      |      |      |      | DEL  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | CAPS |  F5  |  F6  |  F7  |  F8  |      |  Pus | PSc  | HOME | PgUp |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |  F9  |  F10 |  F11 |  F12 |      |      | ScrLk| END  | PgDn |  UP  | INS  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_FKEY] = LAYOUT_ortho_4x12( \
  ...
  KC_CAPS, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, KC_PAUS, KC_PSCR, KC_HOME, KC_PGUP, _______, _______, \
  _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_SLCK, KC_END,  KC_PGDN, KC_UP,   KC_INS, \
